package mk.ukim.finki.filtertwomikroservis.service;

import mk.ukim.finki.filtertwomikroservis.data.DataParser;
import mk.ukim.finki.filtertwomikroservis.model.StockEntity;
import mk.ukim.finki.filtertwomikroservis.model.StockRecordEntity;
import mk.ukim.finki.filtertwomikroservis.repository.StockRepository;
import mk.ukim.finki.filtertwomikroservis.repository.StockRecordRepository;
...
public class FilterTwoService {
    ...
    @Autowired
    public FilterTwoService(StockRepository stockRepository, StockRecordRepository stockRecordRepository) {
